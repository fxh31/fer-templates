<template>
  <a-form :colon="false" layout="vertical" class="right-board-form">
    ...
    <a-form-item label="弹窗类型">
      <fer-select v-model:value="formConf.popupType" :options="popupTypeOptions" :disabled="formConf.dataLog" />
    </a-form-item>
    ...
    <a-form-item>
      ...
      <fer-select v-model:value="formConf.className" multiple allowClear :options="getClassNameOptions" showSearch />
    </a-form-item>
    <a-form-item label="主键策略">
      <fer-select v-model:value="formConf.primaryKeyPolicy" :options="policyOptions" :disabled="!!formInfo.id" />
    </a-form-item>
    <a-form-item>
    ...
    <div class="btn-config-list">
      <div class="btn-cell">
        ...
        <fer-i18n-input v-model:value="formConf.confirmButtonText" v-model:i18n="formConf.confirmButtonTextI18nCode" placeholder="请输入" />
      </div>
      <div class="btn-cell">
        <a-checkbox v-model:checked="formConf.hasCancelBtn" disabled>取消</a-checkbox>
        <fer-i18n-input v-model:value="formConf.cancelButtonText" v-model:i18n="formConf.cancelButtonTextI18nCode" placeholder="请输入" />
      </div>
      <div class="btn-cell" v-if="showType == 'pc'">
        ...
        <fer-i18n-input v-model:value="formConf.printButtonText" v-model:i18n="formConf.printButtonTextI18nCode" placeholder="请输入" />
      </div>
...
<script lang="ts" setup>
  ...
  import FormScript from './components/FormScript.vue'; // 编写表单加载触发脚本
  import StyleScript from './components/StyleScript.vue'; // 编写样式脚本
  // import BusinessKeyCfgModal from './BusinessKeyCfgModal.vue';
  // import CustomBtnCfg from './components/CustomBtnCfg.vue'; // 自定义按钮
