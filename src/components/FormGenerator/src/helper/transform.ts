...
export const getRealProps = (data, ferKey) => {
...
export const getFormSchemaItem = data => {
  const item = getRealProps(data, data.__config__.ferKey);
  ...
  const schema = {
    ...
    component: upperFirst(item.__config__.ferKey),
    componentProps,
