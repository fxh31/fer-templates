<template>
  <TreeSelect class="fer-tree-select" v-bind="getBindValue" v-model:value="innerValue" @change="onChange">
    <template #title="data">
...
<script lang="ts" setup>
  ...
  import { computed, unref, watch, ref, watchEffect, useAttrs } from 'vue';
  ...
  defineOptions({ name: 'FerTreeSelect', inheritAttrs: false });
