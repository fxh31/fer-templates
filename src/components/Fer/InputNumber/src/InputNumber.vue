...
<script lang="ts" setup>
  ...
  import { getAmountChinese, thousandsFormat } from '@/utils/fer';

  defineOptions({ name: 'FerInputNumber', inheritAttrs: false });
  const props = defineProps({
    value: [Number, String],
    thousands: { type: Boolean, default: false }, // 千分符
    isAmountChinese: { type: Boolean, default: false }, // 人中文大写金额
