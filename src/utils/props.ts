/**
 * 封装 Vue 组件的 props 类型定义与构建逻辑
 * Encapsulate the type definition and construction logic of Vue component props
 * @description 借鉴类似 Element Plus 的 prop 构建机制
 */
...
type _BuildPropType<T, V, C> = (T extends PropWrapper<unknown> ? T[typeof wrapperKey] : [V] extends [never] ? ResolvePropTypeWithReadonly<T> : never) | V | C;
